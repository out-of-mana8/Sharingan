...
A Custom embedded vision module with wireless capabilities based on the ESP32-P4 SOM with MIPI CSI, MIPI DSI, 6-axis motion sensing, digital audio, USB-C, and LiPo Charging with BMS.
